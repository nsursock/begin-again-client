...
const ToastAlert = ({ type, title, descr, show = true }) => {
  ...
  const createToastAlert = () => {
    ...
    return (
      ...
      >
        <div class="bg-white mx-5 mt-3 border border-gray-200 shadow-lg rounded-lg flex items-start justify-between py-5 max-w-sm">
  ...
  return !isReady
    ? null
    : createPortal(createToastAlert(), document.querySelector("#toast"));
};
